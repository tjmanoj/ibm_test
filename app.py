...
conn = ibm_db.connect("database=bludb;hostname=9938aec0-8105-433e-8bf9-0fbb7e483086.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;port=32459;uid=ckm92032;pwd=XQ9qq7WRIuVILqDT;security=SSL;sslcertificate=DigiCertGlobalRootCA.crt"," "," ")
print(conn)
